...
Direct, instructional, second-person. Guidelines speak straight to the CSM: "Do not modify the logo in any way," "Refrain from re-creating, resizing disproportionately, or distorting the logo," "Keep slides clean and professional by using only approved visuals."
